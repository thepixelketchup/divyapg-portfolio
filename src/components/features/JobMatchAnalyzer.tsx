...
export const JobMatchAnalyzer = () => {
    ...
    return (
        <div className="max-w-4xl mx-auto mt-20 p-8 rounded-3xl bg-[#111] border border-emerald-500/20 relative overflow-hidden">
            ...
            <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                    <h2 className="text-2xl font-bold text-white">AI Job Matcher ✨</h2>
                    <p className="text-gray-400 text-sm">Paste a JD to see how well I fit the role.</p>
                </div>
            </div>
